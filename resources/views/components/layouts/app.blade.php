    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800 dark">
        ...
        >
            ...
            <flux:navbar class="max-lg:hidden">
                ...
                <flux:navbar.item icon="plus-circle" href="/submit" wire:navigate>Submit Your Config</flux:navbar.item>
            </flux:navbar>
            ...
            @auth
                <flux:dropdown position="bottom" align="end">
                    ...
                    @volt("layout.navigation.profile.dropdown")
                        <flux:navmenu>
                            <flux:navmenu.item href="/profile" wire:navigate icon="building-storefront">
                                Profile
                            </flux:navmenu.item>
        ...
        >
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.item icon="face-smile" href="/submit">Submit a Config</flux:navlist.item>
            </flux:navlist>
        </flux:sidebar>
